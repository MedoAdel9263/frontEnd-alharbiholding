                    ...
                    <div className='flex animate-infinite-scroll items-center justify-center gap-8 md:justify-start lg:gap-[38px] w-full'>
                        {
                            items.map((item) => {
                                return (
                                        <div className='flex items-center justify-center gap-8 lg:gap-[38px] w-full'>
                                            <img className='h2 font-secondary text-accent-900 dark:text-white' src={`http://localhost:1337${item.Image.url}`} />
