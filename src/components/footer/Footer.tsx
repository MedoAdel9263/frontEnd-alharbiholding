                            ...
                            <div data-aos="fade-up" data-aos-delay="800" className="aos-init aos-animate">
                                ...
                                <ul aria-label="addresses" className="grid gap-5">
                                    <li className="flex gap-5">
                                        ...
                                        <a href={`tel:${items[0].Phone}`} className="transition-colors duration-300 hover:text-primary hover:">{items[0].Phone}</a>
                                    </li>
                                    <li className="flex gap-5"><span className="text-primary flex-none leading-none self-start relative top-2">
                                        ...
                                        <a href={`mailto:${items[0].Email}`}  className="transition-colors duration-300 hover:text-primary hover:">{items[0].Email} </a>
                                    </li>
                                    <li className="flex gap-5">
                                        <span className="text-primary flex-none leading-none self-start relative top-2">
