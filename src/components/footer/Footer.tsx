...
function Footer({ items }: { items: any }) {
    ...
    return (
        <>
            <footer className=' overflow-hidden bg-accent-100 text-accent-800 dark:text-body dark:bg-accent-900 relative bottom-[-25px] w-full'>
                <div className="pt-[2rem] px-[16px] mx-0 md:mx-10 lg:mx-14 ">
                    ...
                    <div className="border-y border-accent-800 border-opacity-30 py-[60px] border-accent-100 border-opacity-30">
                        <div className="grid gap-10 md:grid-cols-2">
                            <div data-aos="fade-up" data-aos-delay="200" className="aos-init aos-animate">
                                <h3 className="text-gray-900  text-md font-bold leading-[1.25] md:text-lg mb-5 md:mb-[1.875rem]">Quick Links</h3>
                                <nav aria-label="footer links navigation">
                                    <ul className="grid gap-2">
                                        <li className="flex items-center gap-2.5">
                                            <a target="_self" className="transition-colors duration-300 hover:text-primary hover:" onClick={() => router('/')}>Home</a>
                                        </li>
                                       
                                        <li className="flex items-center gap-2.5">
                                            <a target="_self" className="transition-colors duration-300 hover:text-primary hover:" onClick={() => router('/company')}>Companies</a>
                                        </li>
                                        <li className="flex items-center gap-2.5">
                                            <a target="_self" className="transition-colors duration-300 hover:text-primary hover:"onClick={() => router('/partners')}>Our Partners</a>
                                        </li>
                                        <li className="flex items-center gap-2.5">
                                            <a target="_self" className="transition-colors duration-300 hover:text-primary hover:" onClick={() => router('/about-us')}>About us</a>
                                        </li>
                                        <li className="flex items-center gap-2.5">
                                            <a target="_self" className="transition-colors duration-300 hover:text-primary hover:" onClick={() => router('/contact-us')}>Contact us</a>
                                        </li>
                                    </ul>
                                </nav>
                            </div>
                            <div data-aos="fade-up" data-aos-delay="800" className="aos-init aos-animate">
                                <h3 className="text-gray-900  text-md font-bold leading-[1.25] md:text-lg mb-5 md:mb-[1.875rem]">Contact Us</h3>
                                <ul aria-label="addresses" className="grid gap-5">
                                    <li className="flex gap-5">
                                        ...
                                        <a href="tel:+966(012)6991333" className="transition-colors duration-300 hover:text-primary hover:">{items[0].Phone}</a>
                                    </li>
                                    <li className="flex gap-5"><span className="text-primary flex-none leading-none self-start relative top-2">
                                        ...
                                        <a href="mailto:info@alharbiholding.com.sa" className="transition-colors duration-300 hover:text-primary hover:">info@alharbiholding.com.sa</a>
                                    </li>
                                    <li className="flex gap-5">
                                        <span className="text-primary flex-none leading-none self-start relative top-2">
                                        ...
                                        <address className="not-italic">{items[0].Address}</address>
                                    </li>
                                </ul>
                            </div>
                        </div>
